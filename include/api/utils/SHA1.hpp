...
#ifndef ARCADE_SHA1_HPP
#define ARCADE_SHA1_HPP
...
namespace arcade::api::utils {
    ...
    */
    ...
    public:
        ...
        /**
         * @brief Create a sha1 from a string
         * @param toHash the string to hash
         * @return the hashed string
         */
        inline static std::string create(const std::string &toHash)
        {
            SHA1 checksum;
        ...
        inline static std::string from_file(const std::string &filename)
        {
    ...
    private:
         ...
         * @param block The 512-bit block to hash.
         */
        inline void transform(uint32 block[BLOCK_BYTES])
        {
        ...
        inline static void buffer_to_block(const std::string &buffer, uint32 block[BLOCK_BYTES])
        {
...
using SHA1 = arcade::api::utils::SHA1;

#endif //ARCADE_SHA1_HPP
